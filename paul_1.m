...
%%   
% ===============================================
cd('C:\Users\skoch\Desktop\efficientLBP')
cf;clear
f1='F:\data10\oxford_exvivo\dat\20260226_jh_DTH_exvivo_LA01_MPM_DTI_exvivo\t2.nii'
[ha a]=rgetnii(f1);
imgRGB=squeeze(a(:,:,24));
imgRGB=mat2gray(imgRGB);
img=imgRGB;
