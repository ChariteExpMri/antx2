...
function xcreateTPMfromANO(anofile,fibfile, outpath)

if 0
    anofile ='O:\harms1\harms4\templates\ANO.nii'
fibfile ='O:\harms1\harms4\templates\FIBT.nii'
outpath='O:\harms1\harms4\templates'
    
 xcreateTPMfromANO(anofile,fibfile, outpath)
end
...
rsavenii(fullfile(outpath,'_agrey.nii'),ha,   a2 ,[2 0]);
rsavenii(fullfile(outpath,'_awhite.nii'),ha,   b ,[2 0]);
rsavenii(fullfile(outpath,'_acsf.nii'),      ha,   c ,[2 0]);
