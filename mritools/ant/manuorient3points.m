...
title({['Ref: ' u.f1name ]; ['  ' fileparts(u.f1) ] },'fontsize',u.fs-1); axis off;
set(gca,'tag','axa');
hold on;
...
% title(['Source: ' u.f2name ],'fontsize',u.fs);axis off;
title({['Source: ' u.f2name ]; ['  ' fileparts(u.f2) ] },'fontsize',u.fs-1); axis off;
