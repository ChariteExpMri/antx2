...
% P ..struct with:
%       yname: {'O:\data4\ant_upd2_win\dat\m09\y_forward.nii'}
%      iyname: {'O:\data4\ant_upd2_win\dat\m09\y_inverse.nii'}
%     matname: {'O:\data4\ant_upd2_win\dat\m09\reorient.mat'}
% ..used [spm_load_float.m] (not found in spm12)

function out = FB_dti_realigndef_ui(P)
