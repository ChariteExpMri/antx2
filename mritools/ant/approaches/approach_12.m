% #ok approach_12: 
% #b DETAILS: 
% #k moving IMAGE brainmask:  - using GM & WM
% #k                          - fill holes in mask
% #k                          - remove pixels outide mask+smoooth mask
% #k moving IMAGE: combination of #bo GM, WM & CSF #kw +offset
% #r               -image is masked by brainmask
% #k fixed  IMAGE: -combination of #bo GM, WM & CSF #kw +offset
