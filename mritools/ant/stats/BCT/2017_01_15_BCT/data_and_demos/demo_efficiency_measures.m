...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,1); imagesc(adj);axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,2); imagesc(adj);axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,3); imagesc(adj); ;axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,4); imagesc(adj);axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,5); imagesc(adj);axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,6); imagesc(adj);axis image
...
Eres = mean(Eres(~EYE));
disp([prob_SPL,Erout,Ediff,Eres])
subplot(3,3,7); imagesc(adj);axis image
