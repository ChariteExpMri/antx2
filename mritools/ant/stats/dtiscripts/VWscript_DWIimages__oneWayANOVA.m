...
% FOR INDEPENDENT GROUPS WITH MORE THAN 2 GROUPS   ....thus 'onewayanova' is used
% 
% <b><font color=BLUE><u>    ONE-WAY ANOVA (BETWEEN DESIGN)     :</u></font></b> 
% 
% [1] a one-way anova is used ..groups has to be specified in the group-assignment file
...
pamain     ='F:\data7\ag_mundlos_bugVoxstat';       %PLEASE MODIFY: THE STUDY-FOLDER
paout      =fullfile(pamain,'voxstat');                      %PLEASE MODIFY: THE MAIN-OUTPUT-FOLDER   
groupfile  =fullfile(pamain,'group','animal_groups.xlsx' ); %PLEASE MODIFY: NAME OF THE GROUP-ASSIGNMENT FILE
