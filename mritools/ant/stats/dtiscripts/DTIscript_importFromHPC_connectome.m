%% <b> script to copy the 'connectome' from HPC to target directory</b>
% <font color="red">- use this script when DTI-processing is finished  </font> to copy files to a target-folder
...
% - use this script to copy the connectome for statistical analysis (via "dtistat.m")
...
paoutTarget='H:\Daten-2\Imaging\AG_Boehm_Sturm\ERA-Net_topdownPTSD\Brains_charge2_July2021\statistic\DTI\dat' %output-directory

files2export={...         %these files will be copied
    'atlas_lut.txt'
    'connectome_di_sy.csv'
    '*.png'               %copy also the screenShots
    };
%===================================================================================================
