...
paHPCstudy_asW     = 'X:\Imaging\Paul_DTI\AG_meisel_test2'  ;% HPC-TARGET-path as seen from WINDOWS (asW)

% [painDat]: WINDOWS-folder withINPUT-data for DTI-processing ; form ["studypath"+"DTI_export4mrtrix"+"dat"]
painDat  = fullfile( 'H:\Daten-2\Imaging\AG_Meisel\2023_CXCL13_Flox_d56\rsMRI_DTI'    ,...
    'DTI_export4mrtrix');

bash.jobName       = 'meis2'   ; % arbitrary name of jobname in bashfile (no space, specific characters)
