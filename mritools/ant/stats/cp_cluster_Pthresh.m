...
% 
% source: https://github.com/CyclotronResearchCentre/SPM_ClusterSizeThreshold
% 1) look at your SPM results, using a voxel-wise uncorrected p-value threshold,
% i.e. typically the .001 uncorrected cluster forming threshold
% 2) run K_thresh = cp_cluster_Pthresh(xSPM, p_val) where xSPM is a structure
% available in your Matlab workspace when looking at SPM results and p_val 
% is the statistical threshold you want [.05 by default if omitted].
