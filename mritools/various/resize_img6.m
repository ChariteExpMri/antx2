function outfile=resize_img6(imname,outname, Voxdim,imgdim, BB, ismask, interpmethod, dt)

% resize_img6('t2.nii','ht2.nii',[],[256 256 32].*2 ,bb, [], 1)
% resize_img6('t2.nii','ht2.nii',[.12 .12 .3], [],bb, [], 1)
...
for V=vols'
    ...
    if isvoxdim==0
        vm=spm_imatrix(V.mat);
        vx=vm(7:9);
        Voxdim=(V.dim./imgdim).*vx;
        voxdim = Voxdim;
