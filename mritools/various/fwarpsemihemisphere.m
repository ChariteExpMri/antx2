function s=fwarpsemihemisphere(mystruct)

%% warp brain for each heisphere, separately
% function s=fwarpsemihemisphere(mystruct)
% s=fwarpsemihemisphere(1)  : yields a struct with predefined fieldnames and examplary entries (which has to be modified)
